...
--                                                                     --
--  © 2021-2025 Eetu Rantanen            Last Updated: 4 February 2025 --
-------------------------------------------------------------------------
--  License: MIT                                                       --
-------------------------------------------------------------------------
...
function Runtime:addEventListener( eventName, listener )
	-- Allow key events on iOS (sim) to be added without warnings.
	if not isSimulator and eventName == "key" and platform == "ios" then
		return
	end
