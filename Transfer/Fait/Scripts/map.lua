...
function map.start( parent, sceneParams )
	if not hasStarted then
		...
		local img = "map" .. userdata.player.playerClass:sub(1,1):upper(1,1) .. userdata.player.playerClass:sub(2):lower() .. ".png"

		local subscale = 0.75
		player = display.newImageRect( groupMap, "Resources/Images/Characters/" .. img, imageWidth, imageHeight )
